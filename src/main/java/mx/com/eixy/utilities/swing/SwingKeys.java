...
public class SwingKeys {
	...
	private static void keyStroke2String(KeyStroke key) {
	...
	/**
	 * <p>Asigna una combinación de teclas a un método.</p>
	 * @param jComponent
	 * @param whenInFocus
	 * @param keyStroke
	 * @param runnable
	...
	public static void add(JComponent jComponent, int whenInFocus, String keyStroke, final Runnable runnable) {
		jComponent.getInputMap(whenInFocus).put(KeyStroke.getKeyStroke(keyStroke), keyStroke);
		jComponent.getActionMap().put(keyStroke, new AbstractAction() {

			private static final long serialVersionUID = 1L;

			public void actionPerformed(ActionEvent e) {
				System.out.println("chido el runnable 3!!!");
				runnable.run();
	...
	public static void addEscapeListener(final JFrame jFrame) {
	    ActionListener escListener = new ActionListener() {

	        @Override
	        public void actionPerformed(ActionEvent e) {
	        	System.out.println("Destruyendo el wondow");
	        	jFrame.dispose();
